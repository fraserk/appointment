<template>
    ...
    <div class="flex flex-wrap -mx-2 ">
      <div class=" md:mx-0 w-full md:w-1/3 px-2" v-show="!selectedProvider">
        <div class="rounded border">
          ...
          <div class="p-4 bg-white">
            ...
            <div class="flex flex-wrap">
              <div class="w-full">
                <div class=" flex  bg-white border border-l-8  border-grey-lighter p-4 mb-4 mt-4 hover:border-grey-dark cursor-pointer" v-for="provider in providers" :key="provider.id">
      ...
      <div class="w-full  px-2 mt-4 md:mt-0">
        <appointment-calendar :provider="selectedProvider" :service="bookedService" v-if="showCalendar">  </appointment-calendar>
      </div>
    </div> 
</template>
...
export default{
  components: {
    ...
    props:['company','service'],
     data(){
       return{
             providers: this.company.providers,
             selectedProvider: null,
             showCalendar:null,
             bookedService: this.service.id
         }
     },
     methods:{
